...
export default function Alphabet (props: IconI) {
    const iconColour = `${props.color}`
    return (
        <div className="flex cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={iconColour} className="bi bi-alphabet" viewBox="0 0 16 16">
