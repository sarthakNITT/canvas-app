...
export default function Unlock (props: IconI) {
    const iconColour = `${props.color}`
    return(
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill={iconColour} className="bi bi-unlock2" viewBox="0 0 16 16">
